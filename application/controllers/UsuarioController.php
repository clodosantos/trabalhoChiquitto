...
class UsuarioController extends Blog_Controller_Action {
    ...
    public function createAction() {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($form->isValid($values)) {
                ...
                $flashMessenger->addMessage('Usuario salvo!');
    ...
    public function updateAction() {
        ...
        if (!$adminRow) {
            $flashMessenger->addMessage('Usuario inexistente!');
            $this->_helper->redirector->gotoSimpleAndExit('index');
        }
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($form->isValid($values)) {
                ...
                $flashMessenger->addMessage('Usuario atualizado!');
